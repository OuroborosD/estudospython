...
import numpy as np
from funcoes_aux import nome_imagem_v3,dividir_lista,quantidade_de_barras,cor,barras_grafico
...
for i in range(5,21,5):#esse loop é o que seleciona as letras. pula de 5 em 5.
    ...
    if controle == 0:#vai execultar um vez ao final do codigo, pois quando sai da subtração do controle  é a primeira vez que tem o valor de 0
        ...
        while inc < 2:
            for la in range(0,9,3):#vai do primeiro ao decimo item
                ...
                tempo1,tempo2,tempo3,tempo4 = dividir_lista(1,lista,inc),dividir_lista(2,lista,inc),dividir_lista(3,lista,inc),dividir_lista(4,lista,inc)
                gra = []
                ...
                for i in range(0,qtd_barras):#servve para ficar chamando novas barras, automaticamente sem rpecisa de coido
